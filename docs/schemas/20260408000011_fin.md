...
| farm_name | TEXT | FK → org_farm(name), nullable | Nullable — the expense spreadsheet does not currently carry a Farm column. Populated later when expenses are farm-tagged (likely derivable from class_name) |
