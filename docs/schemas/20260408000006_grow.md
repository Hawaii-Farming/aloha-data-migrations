...
| grow_cuke_harvest_v (view) | Cuke-only harvest weigh-ins joined to their cuke seed batch for reporting. |
| grow_lettuce_harvest_v (view) | Lettuce-only harvest weigh-ins joined to their lettuce seed batch for reporting. |
...
## grow_lettuce_harvest_v (view)

Lettuce-only harvest weigh-ins joined to their lettuce seed batch for reporting. Same pattern as `grow_cuke_harvest_v` but for lettuce (filters on `grow_lettuce_seed_batch_id IS NOT NULL` and joins `grow_lettuce_seed_batch`).
