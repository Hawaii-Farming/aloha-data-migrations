CREATE TABLE IF NOT EXISTS grow_seed_batch (
    ...
    CONSTRAINT uq_grow_seed_batch UNIQUE (org_id, batch_code),
    CONSTRAINT chk_grow_seed_batch_source CHECK (
...
CREATE INDEX idx_grow_seed_batch_item ON grow_seed_batch (invnt_item_id);
CREATE INDEX idx_grow_seed_batch_mix ON grow_seed_batch (grow_seed_mix_id);
