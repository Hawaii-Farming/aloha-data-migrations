CREATE TABLE IF NOT EXISTS grow_fertigation_recipe_site (
    ...
    CONSTRAINT uq_grow_fertigation_recipe_site UNIQUE (grow_fertigation_recipe_name, site_id)
);
...
CREATE INDEX idx_grow_fertigation_recipe_site_recipe ON grow_fertigation_recipe_site (grow_fertigation_recipe_name);
