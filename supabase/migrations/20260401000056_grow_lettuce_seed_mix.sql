CREATE TABLE IF NOT EXISTS grow_lettuce_seed_mix (
    ...
    CONSTRAINT uq_grow_lettuce_seed_mix UNIQUE (org_id, farm_id, id),
    CONSTRAINT grow_lettuce_seed_mix_farm_fkey FOREIGN KEY (org_id, farm_id) REFERENCES org_farm(org_id, id)
);
