...
-- Original prod migration: version=20260514185708, name='staffing_view_exclude_execs_and_maint'.
...
WITH ranked AS (
  ...
  WHERE p.is_deleted = false
    ...
    AND e.compensation_manager_id NOT IN ('feder_leonard', 'cervantes_acosta_eric_abraham')
)
SELECT
...
-- Same filter on the detail view
