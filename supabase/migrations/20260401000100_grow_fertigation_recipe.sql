CREATE TABLE IF NOT EXISTS grow_fertigation_recipe (
    ...
    CONSTRAINT uq_grow_fertigation_recipe UNIQUE (org_id, farm_id, id),
    CONSTRAINT grow_fertigation_recipe_farm_fkey FOREIGN KEY (org_id, farm_id) REFERENCES org_farm(org_id, id)
);
