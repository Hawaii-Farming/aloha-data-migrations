CREATE TABLE IF NOT EXISTS grow_cycle_pattern (
    ...
    CONSTRAINT uq_grow_cycle_pattern UNIQUE (org_id, farm_id, id),
    CONSTRAINT grow_cycle_pattern_farm_fkey FOREIGN KEY (org_id, farm_id) REFERENCES org_farm(org_id, id)
);
