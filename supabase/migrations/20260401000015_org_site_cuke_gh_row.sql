...
COMMENT ON COLUMN org_site_cuke_gh_row.row_number IS 'Physical row number. Unique within a greenhouse. Used on labels and for crew navigation. Block membership is derived by joining to org_site_cuke_gh_block on site_id where row_number is between row_num_from and row_num_to';
