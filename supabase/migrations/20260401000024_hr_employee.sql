CREATE TABLE IF NOT EXISTS hr_employee (
    ...
    team_lead_name                 TEXT,
    compensation_manager_name      TEXT,
    ...
    CONSTRAINT fk_hr_employee_team_lead
      FOREIGN KEY (team_lead_name) REFERENCES hr_employee(name),
    CONSTRAINT fk_hr_employee_compensation_manager
      FOREIGN KEY (compensation_manager_name) REFERENCES hr_employee(name)
);
...
CREATE INDEX idx_hr_employee_team_lead  ON hr_employee (team_lead_name);
CREATE INDEX idx_hr_employee_department ON hr_employee (hr_department_name);
...
COMMENT ON COLUMN hr_employee.team_lead_name IS 'Filtered to employees with sys_access_level_name = team_lead';
COMMENT ON COLUMN hr_employee.compensation_manager_name IS 'Filtered to employees with sys_access_level_name = manager';
