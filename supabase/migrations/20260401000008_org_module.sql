CREATE TABLE IF NOT EXISTS org_module (
    ...
    CONSTRAINT uq_org_module UNIQUE (org_id, sys_module_name)
);
...
COMMENT ON COLUMN org_module.sys_module_name IS 'Sourced from sys_module; identifies which system module this org copy represents';
COMMENT ON COLUMN org_module.display_name IS 'Pre-filled from sys_module.name at provisioning time; editable by org admins';
