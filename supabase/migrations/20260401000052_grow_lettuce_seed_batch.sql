...
COMMENT ON COLUMN grow_lettuce_seed_batch.grow_seed_mix_id IS 'Set when seeding a mix; null when seeding a single variety. Mutually exclusive with invnt_item_id';
COMMENT ON COLUMN grow_lettuce_seed_batch.invnt_item_id IS 'Set when seeding a single seed item; null when seeding a mix. Mutually exclusive with grow_seed_mix_id';
...
CREATE INDEX idx_grow_lettuce_seed_batch_mix ON grow_lettuce_seed_batch (grow_seed_mix_id);
