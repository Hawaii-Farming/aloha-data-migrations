CREATE TABLE IF NOT EXISTS sales_po_fulfillment (
    ...
    sales_container_type_name TEXT REFERENCES sales_container_type(name),
    container_id        TEXT,
    booking_id          TEXT,
    pallet_number       TEXT,
...
COMMENT ON COLUMN sales_po_fulfillment.sales_container_type_name IS 'Container type used for shipping; set during containerization';
