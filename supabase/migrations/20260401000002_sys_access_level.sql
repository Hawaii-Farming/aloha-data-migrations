CREATE TABLE IF NOT EXISTS sys_access_level (
    ...
    CONSTRAINT uq_sys_access_level_name UNIQUE (id)
);
...
COMMENT ON COLUMN sys_access_level.id IS 'Human-readable identifier (e.g. employee, team_lead, manager, admin, owner)';
