CREATE TABLE IF NOT EXISTS grow_lettuce_seed_mix_item (
    ...
    grow_lettuce_seed_mix_name TEXT NOT NULL REFERENCES grow_lettuce_seed_mix(name),
    ...
    CONSTRAINT uq_grow_lettuce_seed_mix_item UNIQUE (grow_lettuce_seed_mix_name, invnt_item_name)
);
...
COMMENT ON COLUMN grow_lettuce_seed_mix_item.invnt_lot_id IS 'Sourced from invnt_lot filtered by the selected invnt_item_name';
