CREATE TABLE IF NOT EXISTS pack_shelf_life_result (
    ...
    pack_shelf_life_metric_name    TEXT NOT NULL REFERENCES pack_shelf_life_metric(name),
    ...
    CONSTRAINT uq_pack_shelf_life_result UNIQUE (pack_shelf_life_id, pack_shelf_life_metric_name, observation_date)
);
...
CREATE INDEX idx_pack_shelf_life_result_check  ON pack_shelf_life_result (pack_shelf_life_metric_name);
