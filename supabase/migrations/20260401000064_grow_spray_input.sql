...
COMMENT ON COLUMN grow_spray_input.invnt_item_name IS 'Pre-filled from grow_spray_compliance.invnt_item_name';
...
COMMENT ON COLUMN grow_spray_input.invnt_lot_id IS 'Sourced from invnt_lot filtered by the selected invnt_item_name';
