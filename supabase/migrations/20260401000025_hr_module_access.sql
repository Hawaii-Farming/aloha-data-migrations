CREATE TABLE IF NOT EXISTS hr_module_access (
    ...
    CONSTRAINT uq_hr_module_access UNIQUE (hr_employee_name, org_module_name)
);
...
CREATE INDEX idx_hr_module_access_employee ON hr_module_access (hr_employee_name);
...
CREATE INDEX IF NOT EXISTS idx_hr_module_access_employee_module
  ON public.hr_module_access(hr_employee_name, org_module_name);
