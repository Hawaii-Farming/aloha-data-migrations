...
CREATE UNIQUE INDEX uq_pack_productivity_fail_category_org ON pack_productivity_fail_category (org_id, name) WHERE farm_name IS NULL;
CREATE UNIQUE INDEX uq_pack_productivity_fail_category_farm ON pack_productivity_fail_category (org_id, farm_name, name) WHERE farm_name IS NOT NULL;
