CREATE TABLE IF NOT EXISTS invnt_po (
    ...
    burn_uom               TEXT NOT NULL REFERENCES sys_uom(id),
    order_uom              TEXT NOT NULL REFERENCES sys_uom(id),
...
COMMENT ON COLUMN invnt_po.item_name IS 'Snapshot from invnt_item.id for inventory_item; manually entered for non_inventory_item';
